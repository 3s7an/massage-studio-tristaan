    ...
    <h2 class="text-center mb-3 mt-0" id="services">Our services and prices <i class="fa-solid fa-down-long"></i></h2>
        ...
        <div class="accordion-item mt-5">
          <h3 class="accordion-header">
            ...
            <p>Swedish Massage -> <span class="swedish">30<i class="fa-solid fa-euro-sign"></i></span></p>
            </button>
          </h3>
        ...
        <div class="accordion-item">
          <h3 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
              <p>Trigger point Massage -> <span class="trigger">32<i class="fa-solid fa-euro-sign"></i></span></p>
            </button>
          </h3>
        ...
        <div class="accordion-item">
          <h3 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
              <p>Thai massage -> <span class="thai">38<i class="fa-solid fa-euro-sign"></i></span></p>
            </button>
          </h3>
          <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <p>
                    During a Thai massage session, the recipient typically lies on a padded mat on the floor while the practitioner uses their hands, elbows, knees, and feet to apply pressure along energy lines and specific points of the body. The session involves a series of rhythmic compressions, stretches, and passive joint movements, aiming to improve flexibility, relieve muscle tension, and balance the body's energy systems <br> Price: 60e
                </p>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
            <h3 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree">
                <p>Hot Stone Massage -> <span class="hot">28<i class="fa-solid fa-euro-sign"></i></span></p>
              </button>
            </h3>
          ...
          <div class="accordion-item">
            <h3 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseThree">
               <p>Lymphatic drainage Massage -> <span class="lymphatic">45<i class="fa-solid fa-euro-sign"></i></span></p> 
              </button>
            </h3>
          ...
          <div class="accordion-item">
            <h3 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseThree">
                <p>Cupping -> <span class="cupping">30<i class="fa-solid fa-euro-sign"></i></span></p>
